...
from vini import NeuralNetwork, Neuron, sigmoid, derivative_sigmoid
...
neural_network.add_layer(width=512, activation_function=sigmoid, derivative_function=derivative_sigmoid)
neural_network.add_layer(width=10, activation_function=sigmoid, derivative_function=derivative_sigmoid)
